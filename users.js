...
$(document).ready(function(){
  ...
  $('body').find('#user').text(showUser.toUpperCase());
        ...
        function mailPopup(contactId) {
            ...
            //scriptContent='<script src="https://ajax.aspnetcdn.com/ajax/jQuery/jquery-3.3.1.min.js"></script>';
            //scriptContent+='<script src="http://localhost/contactmanager/mail.js"></script>';
